...
ROUTER_MESH_TEMPLATE_FILE="" # TODO
...
# TODO /usr/local/sbin/generate_config -p /etc/nginx/router-mesh/router-mesh_config_local.yaml -t /etc/nginx/router-default-location.conf.j2 > /etc/nginx/default-location.conf
